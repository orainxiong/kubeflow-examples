...
dataflow_tf_predict_op          = components.load_component_from_url('https://raw.githubusercontent.com/orainxiong/kubeflow-examples/master/tfx_cab_classification/pipeline/components/dataflow/predict/component.yaml')

confusion_matrix_op             = components.load_component_from_url('https://raw.githubusercontent.com/orainxiong/kubeflow-examples/master/tfx_cab_classification/pipeline/components/local/confusion_matrix/component.yaml')
roc_op                          = components.load_component_from_url('https://raw.githubusercontent.com/orainxiong/kubeflow-examples/master/tfx_cab_classification/pipeline/components/local/roc/component.yaml')

kubeflow_deploy_op              = components.load_component_from_url('https://raw.githubusercontent.com/orainxiong/kubeflow-examples/master/tfx_cab_classification/pipeline/components/kubeflow/deployer/component.yaml')
...
def taxi_cab_classification(
    output,
    project,
    column_names='{{inputs.parameters.output}}/pipelines/samples/core/tfx_cab_classification/taxi-cab-classification/column-names.json',
    key_columns='trip_start_timestamp',
    train='{{inputs.parameters.output}}/pipelines/samples/core/tfx_cab_classification/taxi-cab-classification/train.csv',
    evaluation='{{inputs.parameters.output}}/pipelines/samples/core/tfx_cab_classification/taxi-cab-classification/eval.csv',
    mode='local',
    preprocess_module='{{inputs.parameters.output}}/pipelines/samples/core/tfx_cab_classification/taxi-cab-classification/preprocessing.py',
    learning_rate=0.1,
